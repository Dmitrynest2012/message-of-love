...
function createContainer() {
    ...
    if (!existingContainer) {
        ...
        // Создаем HTML-разметку текста внутри контейнера
        container.innerHTML = `
        <div class="history-header">История изменений:</div>
<div class="history-content">
    <div>
        <span class="date">сборка 0.7.2 [04.03.2024]</span><br>
        <span class="change">- Добавлена кнопка с Историей изменений в левый-верхний угол сайта.<br> 
        - При нажатии на кнопку Истории изменений откроется окно с этой истории, его можно вертикально прокручивать. Описание пока в черновом варианте.<br>
        - Исправление поведения кнопки Открытия таблицы, теперь кнопка блокируется вне Посылов, но становится доступна за 5 минут до подготовки к Посылу.<br> 
        - Счетчик посещений теперь не является кликабельной ссылкой.</span>
    </div>
    <div>
        <span class="date">сборка 0.7.0 [03.03.2024]</span><br>
        <span class="change">- Подключена Яндекс метрика.<br> 
        - Добавлен счетчик посещений сайта. Данные в нем обновляются автоматически.<br>
        - Счетчик автоматически скрывается во время Посыла.</span>
    </div>
    <div>
        <span class="date">сборка 0.6.8 [02.03.2024]</span><br>
        <span class="change">- Доработан режим Администратора.<br> 
        - Можно выходить из Админ-режима.<br> 
        - В моменте Посыла аудиоплеер может проигрывать только Болеро.</span>
    </div>
    <div>
        <span class="date">сборка 0.6.1 [29.02.2024]</span><br>
        <span class="change">- Добавлен режим Администратора.<br> 
        - Авторизация для полного доступа.<br> 
        - Панель управления в режиме Администратора.</span>
    </div>
    <div>
        <span class="date">сборка 0.5.0 [27.02.2024 и от начала Проекта]</span><br>
        <span class="change">- Множество исправлений.<br> 
        - Во время подготовки к Посылу и при Посыле отображается Мыслеобраз. Вне всего этого - случайные картинки космоса.<br> 
        - Добавлено множество изображений космоса и музыки.<br>
        - Теперь можно вертикально прокручивать блок, внутри которого находится время и текст Посыла.<br>
        - Добавлена система браузерных уведомлений, пока работает в тестовом режиме.<br>
        - Включено отображение рандомного блока с четверостишьем, при нажатии на него пользователь перейдет на сайт Катренов в соответствующий катрен. Блок скрывается во время Посыла.<br>
        - Когда идет Посыл, то отображается его текст в соответствии с временными интервалами. В остальное время показывается, сколько осталось до следующего Посыла.</span>
    </div>
    <!-- Добавьте здесь другие записи истории изменений по аналогии -->
</div>
